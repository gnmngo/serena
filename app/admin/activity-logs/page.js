  ...
  return (
    <div className="space-y-6 animate-fadeInUp">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
        ...
        <Card><CardContent className="p-4"><p className="text-sm text-muted-foreground">Budget Additions</p><p className="text-2xl font-bold text-blue-600">{financialStats.additions}</p></CardContent></Card>
        <Card><CardContent className="p-4"><p className="text-sm text-muted-foreground">Budget Deletions</p><p className="text-2xl font-bold text-red-600">{financialStats.deletions}</p></CardContent></Card>
        <Card><CardContent className="p-4"><p className="text-sm text-muted-foreground">Critical Actions</p><p className="text-2xl font-bold text-red-500">{financialStats.critical}</p></CardContent></Card>
        <Card><CardContent className="p-4"><p className="text-sm text-muted-foreground">Most Active Admin</p><p className="text-2xl font-bold truncate">{financialStats.topAdmin}</p></CardContent></Card>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
            ...
            <Select value={filter.action} onValueChange={(val) => setFilter({...filter, action: val})}><SelectTrigger><SelectValue placeholder="Action" /></SelectTrigger><SelectContent><SelectItem value="all">All</SelectItem><SelectItem value="create">Create</SelectItem><SelectItem value="update">Update</SelectItem><SelectItem value="delete">Delete</SelectItem></SelectContent></Select>
